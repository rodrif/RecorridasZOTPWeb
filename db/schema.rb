...
ActiveRecord::Schema.define(version: 2021_03_05_000259) do
  ...
  create_table "familias", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "nombre"
    t.bigint "zone_id"
    t.bigint "ranchada_id"
    t.text "descripcion"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "state_id"
    t.index ["ranchada_id"], name: "index_familias_on_ranchada_id"
    t.index ["state_id"], name: "index_familias_on_state_id"
    t.index ["zone_id"], name: "index_familias_on_zone_id"
  end
  ...
  create_table "people", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["familia_id"], name: "index_people_on_familia_id"
    t.index ["institucion_id"], name: "index_people_on_institucion_id"
    t.index ["ranchada_id"], name: "index_people_on_ranchada_id"
    t.index ["state_id"], name: "index_people_on_state_id"
    t.index ["zone_id"], name: "index_people_on_zone_id"
  end

  create_table "ranchadas", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "nombre"
    t.bigint "zone_id"
    t.text "descripcion"
    ...
    t.datetime "updated_at", null: false
    t.bigint "state_id"
    t.index ["state_id"], name: "index_ranchadas_on_state_id"
    t.index ["zone_id"], name: "index_ranchadas_on_zone_id"
  end
